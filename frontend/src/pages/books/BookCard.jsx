      ...
      >
        ...
        <div>
          ...
          <p className="font-medium mb-5">
            Kes{book?.newPrice} <span className="line-through font-normal ml-2">Kes{book?.oldPrice}</span>
          </p>
          <button
          onClick={()=> handleAddToCart(book)}
          className="bg-[#FFCE1A] px-8 space-x-1 flex items-center gap-1 rounded-md  hover:bg-green-400">
